...
sub get_annotation_key_word{
    ...
    $hashKeyWord{'outfile_library'}                = "$report_dir/library/library";
    $hashKeyWord{'outfile_library.AnnovarBuild'}   = "$report_dir/library/library.$AnnovarBuild";
...
sub get_annotation{
    ...
    $hashAnnotationList{'1000g_chbs'}{'Species'}                 = '[Human_hg19][Human_hg19_HLA]';
    ...
    $hashAnnotationList{'1000g_eas'}{'Species'}                 = '[Human_hg38]';
    $hashAnnotationList{'1000g_eas'}{'From'}                    = 'Annovar';
    $hashAnnotationList{'1000g_eas'}{'Para'}                    = 'annotate_variation.pl -filter -dbtype 1000g2015aug_eas';
    $hashAnnotationList{'1000g_eas'}{'DBDir'}{'Human_hg38'}     = "/home/genesky/database/annovar/hg38/1000g";
    $hashAnnotationList{'1000g_eas'}{'GetResult'}               = 'General SNP';
    $hashAnnotationList{'1000g_eas'}{'Output'}{1}{'File'}       = "prefix=outfile_library.AnnovarBuild\tsuffix=_EAS.sites.2015_08_dropped";
    $hashAnnotationList{'1000g_eas'}{'Output'}{1}{'Need_Info'}  = "1000g_eas=1=2,3,4,5,6"; 
    ...
    $hashAnnotationList{'gnomAD_exome'}{'Species'}                 = '[Human_hg19][Human_hg19_HLA]';
    ...
    $hashAnnotationList{'gnomAD_exome_hg38'}{'Species'}                 = '[Human_hg38]';
    $hashAnnotationList{'gnomAD_exome_hg38'}{'From'}                    = 'Annovar';
    $hashAnnotationList{'gnomAD_exome_hg38'}{'Para'}                    = 'annotate_variation.pl -filter -dbtype gnomad2.1_exome --otherinfo';
    $hashAnnotationList{'gnomAD_exome_hg38'}{'DBDir'}{'Human_hg38'}     = "/home/genesky/database/annovar/hg38/gnomad_exome";
    $hashAnnotationList{'gnomAD_exome_hg38'}{'NecessaryFile'}{1}        = "prefix=AnnovarBuild\tsuffix=_gnomad2.1_exome.txt";
    $hashAnnotationList{'gnomAD_exome_hg38'}{'GetResult'}               = 'General SNP';
    $hashAnnotationList{'gnomAD_exome_hg38'}{'Output'}{1}{'File'}       = "prefix=outfile_library.AnnovarBuild\tsuffix=_gnomad2.1_exome_dropped";
    $hashAnnotationList{'gnomAD_exome_hg38'}{'Output'}{1}{'Need_Info'}  = "gnomAD_exome=1/,/0=2,3,4,5,6\tgnomAD_exome_EAS=1/,/8=2,3,4,5,6\t";
    ...
    $hashAnnotationList{'GeneskyExonDB'}{'Para'}                     = 'annotate_variation.pl -filter -dbtype geneskyExon_GATK4 -otherinfo';
    ...
    $hashAnnotationList{'GeneskyExonDB'}{'DBDir'}{'Human_hg38'}      = "/home/genesky/database/annovar/hg38/genesky_exon";
    $hashAnnotationList{'GeneskyExonDB'}{'NecessaryFile'}{1}         = "prefix=AnnovarBuild\tsuffix=_geneskyExon_GATK4.txt";
    $hashAnnotationList{'GeneskyExonDB'}{'GetResult'}                = 'General SNP';
    $hashAnnotationList{'GeneskyExonDB'}{'Output'}{1}{'File'}        = "prefix=outfile_library.AnnovarBuild\tsuffix=_geneskyExon_GATK4_dropped";
    ...
    $hashAnnotationList{'GeneskyGenomeDB'}{'Species'}                 = '[Human_hg19][Human_hg19_HLA]';
    ...
    $hashAnnotationList{'ICGC'}{'Species'}                   = '[Human_hg19][Human_hg19_HLA]';
    ...
    # 区域注释
    ###
    $hashAnnotationList{'tfbsConsSites'}{'Species'}                  = '[Human_hg19][Human_hg19_HLA]';
    ...
    $hashAnnotationList{'GeneskyExonDB_lowfreq_geneCount'}{'DBDir'}{'Human_hg19'}      = "/home/genesky/database/annovar/hg19/genesky_exon";
    $hashAnnotationList{'GeneskyExonDB_lowfreq_geneCount'}{'DBDir'}{'Human_hg19_HLA'}  = "/home/genesky/database/annovar/hg19/genesky_exon";
    $hashAnnotationList{'GeneskyExonDB_lowfreq_geneCount'}{'DBDir'}{'Human_hg38'}      = "/home/genesky/database/annovar/hg38/genesky_exon";
    $hashAnnotationList{'GeneskyExonDB_lowfreq_geneCount'}{'NecessaryFile'}{1}         = "prefix=AnnovarBuild\tsuffix=_geneskyExon_GATK4_lowfreq_geneCount.txt";
    ...
    $hashAnnotationList{'GeneskyGenomeDB_lowfreq_geneCount'}{'Species'}                = '[Human_hg19][Human_hg19_HLA]';
