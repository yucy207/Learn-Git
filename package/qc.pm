...
sub run_qc{
    ...
    # Q20,Q30统计
    QC2030($fastq_R1, $R1QCData, $FastqStat);
    QC2030($fastq_R2, $R2QCData, $FastqStat);
}
...
sub QC2030{
    ...
    open STATFile,">>$QCData";
    print STATFile ">>Personal Statistics\n";
    print STATFile "#Measure    Value\n";
    print STATFile "BaseCount   $BaseCount\n";
    print STATFile "Q20 $Q20\n";
    print STATFile "Q30 $Q30\n";
    print STATFile ">>END_MODULE\n";
    close STATFile;
}
...
sub read_quality{
    ...
    while(<IN>){
        ...
        if($model eq 'Per base sequence quality')
        {
            ...
            #为什么不直接@base，而是$bases[0]..$bases[$#bases]
            {
